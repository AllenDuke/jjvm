package com.github.allenduke.avm.classfile;
...
import com.github.allenduke.avm.classfile.field.FieldInfo;
...
public class ClassReader {
    ...
    private void parseMethods(ClassFile classFile) {
        ...
        for (int i = 0; i < method_infos.length; i++) {
            ...
            method_info.setAccessFlags(method_info.accessFlagsToString(s));
